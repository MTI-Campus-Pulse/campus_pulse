    ...
    return (
      <>
        ...
        {activeSection === 'reports' 
          ? <ReportsViewer userRole="naqaae" onBack={() => setActiveSection('home')} />
          : <QueriesViewer userRole="naqaae" onBack={() => setActiveSection('home')} />
        }
      </>
    );
  }
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-stone-500 dark:text-slate-400 max-w-2xl mx-auto">
            National Authority for Quality Assurance & Accreditation
          </p>
        </div>
