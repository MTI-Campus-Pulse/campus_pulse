...
// This is the shape of each announcement from the API.
...
interface Announcement {
  ...
  urgent: boolean
  content: string
  image: string | null // null if no image returned
}

// ============================================================
// 🔧 MOCK DATA (delete this when backend is ready)
// Simulates the response from GET /announcements
// ============================================================
...
export default function Home() {
  ...
  // Confirm the endpoint with your backend team: GET /announcements
  // ============================================================
  useEffect(() => {
    const fetchAnnouncements = async () => {
      ...
      try {
        ...
        // ============================================================
        // 🔧 BACKEND INTEGRATION POINT
        // Adjust if the announcements are nested:
        //   response.data         → { id, title, date, urgent, content, image }[]
        //   response.data.data    → { id, title, date, urgent, content, image }[]
        // ============================================================
                  ...
                  return (
                    ...
                    >
                      ...
                      {bulletin.image ? (
                        ...
                        // No image fallback — decorative gradient banner
                        <div className="relative h-3 w-full bg-gradient-to-r from-red-500 via-orange-400 to-yellow-400">
                          {bulletin.urgent && (
                      ...
                      >
                        <div className="flex-1 space-y-2">
                          {/* Show urgent badge here if no image */}
                          {bulletin.urgent && !bulletin.image && (
                            <div className="mt-3" />
                          )}
